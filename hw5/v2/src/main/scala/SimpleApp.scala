...
object SimpleApp {
  ...
  def main(args: Array[String]) {
	...
	val dag = GraphLoader.edgeListFile(spark.sparkContext, "/opt/spark/workplace/dag_edge_list.csv")
    val edges = GraphLoader.edgeListFile(spark.sparkContext, "/opt/spark/workplace/edge_list.csv")
